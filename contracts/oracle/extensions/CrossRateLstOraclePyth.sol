...
abstract contract CrossRateLstOraclePyth is LstOracle {
    ...
    function __CrossRateLstOracle__init(Pyth _aggregatorAddress, address _lsToken, IRatioAdapter _ratioAdapter) internal onlyInitializing {
        lsToken = _lsToken;
    ...
    function _peekLstPrice() internal override view returns (uint256, bool) {
        ...
        Pyth.PriceFeed memory feed = priceFeed.queryPriceFeed(0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace);
