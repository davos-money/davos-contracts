...
contract SfrxEthOracle is CrossRateLstOracle {
    ...
    function initialize(AggregatorV3Interface _aggregatorAddress, address _sfrxETH, IMasterVault _masterVault, IRatioAdapter _ratioAdapter) external initializer {
