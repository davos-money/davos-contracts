...
describe('===FORK===', function () {
    ...
    beforeEach(async function () {
        ...
        await hre.network.provider.request({
            method: "hardhat_impersonateAccount",
            params: ["0x2Ea7CcE60d849870aa21659190CC747edE2BEbA1"],
        });
        await network.provider.send("hardhat_setBalance", [
            "0x2Ea7CcE60d849870aa21659190CC747edE2BEbA1",
            "0x10000000000000000000",
        ]);
        signer2 = await ethers.getSigner("0x2Ea7CcE60d849870aa21659190CC747edE2BEbA1")
    ...
    describe('-', function () {
        ...
        it('MAIN', async function () {
            ...
            console.log("MAIN====");
            let ionUSDC = await ethers.getContractAt("Davos", "0x2BE717340023C9e14C1Bb12cb3ecBcfd3c3fB038");

            await ionUSDC.connect(signer2).approve(davosProvider.address, "1000000");

            await davosProvider.connect(signer2).provide("1000000");

            console.log(await ionUSDC.balanceOf(masterVault.address));
