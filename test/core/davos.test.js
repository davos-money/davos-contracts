...
describe('===Spot===', function () {
    ...
    describe('--- rely()', function () {``
        it('reverts: Davos/not-authorized', async function () {
            await davos.deny(deployer.address);
    ...
    describe('--- approve()', function () {
        it('reverts: Davos/approve-to-zero-address', async function () {
            await expect(davos.approve(NULL_ADDRESS, 1)).to.be.revertedWith("Davos/approve-to-zero-address");
        });
    });
});