...
async function main() {
    ...
    fs.writeFileSync(`./scripts/deployment/addresses_${hre.network.name}_3_1.json`, json_addresses);
    console.log("Addresses Recorded to: " + `./scripts/deployment/addresses_${hre.network.name}_3_1.json`);
}
