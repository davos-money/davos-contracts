...
async function main() {
    ...
    let _underlying = "0xB5beDd42000b71FddE22D3eE8a79Bd49A568fC8F";
    ...
    fs.writeFileSync(`./scripts/addresses_${network.name}_collateral_wstETH.json`, json_addresses);
    console.log("Addresses Recorded to: " + `./scripts/addresses_${network.name}_collateral_wstETH.json`);
}
