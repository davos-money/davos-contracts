...
async function main() {
    ...
    if (hre.network.name == "zkevm") {
        _underlying = "0x12D8CE035c5DE3Ce39B1fDD4C1d5a745EAbA3b8C";
    } else _underlying = "0xf865a20D994DfFF6039A5CD503e418CeaC3A2731"; // Dummy
    _ilk = "0x4d56545f616e6b72455448000000000000000000000000000000000000000000";
    ...
    const addresses = {
        _masterVaultA     : masterVault.address,
    ...
    fs.writeFileSync(`./scripts/collateral/addressesANKRETH_${network.name}.json`, json_addresses);
    console.log("Addresses Recorded to: " + `./scripts/collateral/addressesANKRETH_${network.name}.json`);
}
