...
async function main() {
    ...
    // Config
    let { _masterVault, _davosProvider, _dMatic, _clip, _gemJoin, _ra, _watoken } = require(`../addresses_${hre.network.name}_collateral.json`);
    ...
    this.RatioAdapter = hre.ethers.getContractFactory("RatioAdapter");
    this.WAToken = hre.ethers.getContractFactory("WAToken");
    ...
    let ra = await ethers.getContractAt("RatioAdapter", _ra);
