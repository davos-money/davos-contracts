...
async function main() {
    ...
    let _underlying = "0xf669C3C03D9fdF4339e19214A749E52616300E89";
    ...
    fs.writeFileSync(`./scripts/addresses_${network.name}_collateral_mUSDT.json`, json_addresses);
    console.log("Addresses Recorded to: " + `./scripts/addresses_${network.name}_collateral_mUSDT.json`);
}
